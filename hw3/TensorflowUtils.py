...
def conv2d_basic(x, W, bias, padding="SAME"): #Simple conv and biase addition this function is waste of time replace in the code with the tensorflow command
    conv = tf.nn.conv2d(x, W, strides=[1, 1, 1, 1], padding=padding) #Padding same mean the output is same size as input?
...
def conv2d_atrous(x, W, bias, rate, padding="SAME"):
